...
namespace Minecraft::Protocol {
	...
	int server_difficulty_handler(PacketIn* p) { std::cout << "WARNING SERVER_DIFFICULTY TRIGGERED" << std::endl; return 0; }
	...
	int plugin_message_handler(PacketIn* p) { std::cout << "WARNING PLUGIN_MESSAGE TRIGGERED" << std::endl; return 0; }
	...
	int keep_alive_handler(PacketIn* p) { std::cout << "WARNING KEEP_ALIVE TRIGGERED" << std::endl; return 0; }
	...
	int join_game_handler(PacketIn* p) { std::cout << "WARNING JOIN_GAME TRIGGERED" << std::endl; return 0; }
	...
	int player_abilities_handler(PacketIn* p) { std::cout << "WARNING PLAYER_ABILITIES TRIGGERED" << std::endl; return 0; }
	...
	int held_item_change_handler(PacketIn* p) { std::cout << "WARNING HELD_ITEM_CHANGE TRIGGERED" << std::endl; return 0; }
